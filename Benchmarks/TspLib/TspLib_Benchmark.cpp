...
public:
	struct Options
	{
		...
		Options( )
		    : markov_chain_length_scale(1.f), population_size(8), threads_number(1), multithreading_type(SimulatedAnnealingTSPSolver::MultithreadingType::Auto)
		{
		}
	};
	...
	virtual TSPSolver& createTSPSolver( ) override
	{
		...
		sa_solver.setMutations({SolutionGenerator::MutationType::BlockReverse,
	                                                                                       ...
	                                                                                       "set solver name")("iterations-number,N",
	                                                                                                          ...
	                                                                                                          "set number of iterations")("output-file-name,O",
	                                                                                                                                      ...
	                                                                                                                                      "output file name")("sa-population-size",
	                                                                                                                                                          ...
	                                                                                                                                                          "simulated annealing population size")("sa-threads-number",
	                                                                                                                                                                                                 ...
	                                                                                                                                                                                                 "simulated annealing threads number")("sa-multithreading-type",
	                                                                                                                                                                                                                                       boost::program_options::value<std::string>(&sa_multithreading_type)->default_value("Auto"),
	                                                                                                                                                                                                                                       "simulated annealing multithreading type")("sa-markov-chain-length-scale",
	                                                                                                                                                                                                                                                                                  ...
	                                                                                                                                                                                                                                                                                  "simulated annealing markov chain lenght scale")("sa-temperature-scheduler-name",
	                                                                                                                                                                                                                                                                                                                                   ...
	                                                                                                                                                                                                                                                                                                                                   "simulated annealing temperature scheduler name")("sa-temperature-scheduler-limit",
	                                                                                                                                                                                                                                                                                                                                                                                     ...
	                                                                                                                                                                                                                                                                                                                                                                                     "simulated annealing temperature scheduler iterations limit")("sa-temperature-scheduler-initial-probability",
	                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
	                                                                                                                                                                                                                                                                                                                                                                                                                                                   "simulated annealing temperature scheduler natural log initial probability")("sa-temperature-scheduler-end-probability",
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "simulated annealing temperature scheduler natural log end probability")("sa-list-temperature-scheduler-size",
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "simulated annealing list temperature scheduler size")("sa-list-temperature-scheduler-ratio",
