...
int main(int ac, const char** av)
{
	...
	desc.add_options( )("help", "Display help message")("input", po::value<std::string>( ), "TspLib XML file name to convert to binary format")("output", po::value<std::string>( ), "TspLib binary output file name")("optimum", po::value<uint32_t>( ), "Expected optimal total distance")("problem", po::value<std::string>( ), "Known name of the problem (may be used to automatically set optimal value)");
