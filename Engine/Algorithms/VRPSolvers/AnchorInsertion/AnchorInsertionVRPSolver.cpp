...
namespace Scheduler
{
	...
	{
	public:
		RepairActor(Scene& scene, SceneEditor& scene_editor, const VRPSolver& repair_algorithm)
		    : scene(scene), scene_editor(scene_editor), repair_algorithm(repair_algorithm)
		{
		}
		bool apply( )
		{
