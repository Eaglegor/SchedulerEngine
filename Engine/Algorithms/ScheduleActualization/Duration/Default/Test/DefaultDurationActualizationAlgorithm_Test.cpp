...
TEST_CASE("ScheduleActualizers - StopDurationActualizationAlgorithm", "[integration][functional][schedule_actualizers]")
{
    ...
    Performer& performer = scene_context.createPerformer(scene_context.createDepot(start_location));
	...
	DefaultRouteActualizationAlgorithm& route_actualization_algorithm = am.createAlgorithm<DefaultRouteActualizationAlgorithm>(routing_service);
	actualization_model.setRouteActualizationAlgorithm(route_actualization_algorithm);
	DefaultDurationActualizationAlgorithm& duration_actualization_algorithm = am.createAlgorithm<DefaultDurationActualizationAlgorithm>();
