...
namespace Scheduler
{
	...
	public:
		...
		virtual ValidationContinuancePolicy consumeViolation(const ScheduleShiftEndLocationViolation& violation)
		{
			return genericConsumeViolation(violation);
		}
		virtual ValidationContinuancePolicy consumeViolation(const ScheduleShiftStartLocationViolation& violation)
		{
			return genericConsumeViolation(violation);
		}
