...
namespace std
{
	...
	public:
		...
		front_insert_iterator(LinkedPointersList<Node*>& cont)
		    : cont(&cont)
		{
		}
		front_insert_iterator& operator=(typename LinkedPointersList<Node*>::reference value)
		{
			cont->push_front(value);
			return *this;
		}
		front_insert_iterator& operator=(const front_insert_iterator& rhs)
		{
			this->cont = rhs.cont;
			return *this;
		}
	...
	public:
		...
		front_insert_iterator(LinkedPointersSublist<Node*>& cont)
		    : cont(&cont)
		{
		}
		front_insert_iterator& operator=(typename LinkedPointersSublist<Node*>::reference value)
		{
			cont->push_front(value);
			return *this;
		}
	...
	public:
		...
		front_insert_iterator(LinkedPointersSublist<Node*, LinkedPointersSublist<Node*>>& cont)
		    : cont(&cont)
		{
		}
		front_insert_iterator& operator=(typename LinkedPointersSublist<Node*, LinkedPointersSublist<Node*>>::reference value)
		{
			cont->push_front(value);
			return *this;
		}
	...
	public:
		using container_type = LinkedPointersList<Node*>;
		back_insert_iterator(LinkedPointersList<Node*>& cont)
		    : cont(&cont)
		{
		}
		back_insert_iterator& operator=(typename LinkedPointersList<Node*>::reference value)
		{
	...
	public:
		using container_type = LinkedPointersSublist<Node*>;
		back_insert_iterator(LinkedPointersSublist<Node*>& cont)
		    : cont(&cont)
		{
		}
		back_insert_iterator& operator=(typename LinkedPointersSublist<Node*>::reference value)
		{
			cont->push_back(value);
			return *this;
		}
	...
	public:
		using container_type = LinkedPointersSublist<Node*, LinkedPointersSublist<Node*>>;
		back_insert_iterator(LinkedPointersSublist<Node*, LinkedPointersSublist<Node*>>& cont)
		    : cont(&cont)
		{
		}
		back_insert_iterator& operator=(typename LinkedPointersSublist<Node*, LinkedPointersSublist<Node*>>::reference value)
		{
			cont->push_back(value);
			return *this;
		}
